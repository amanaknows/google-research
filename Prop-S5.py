...
class AngelNETAutomation:
    def __init__(self, user):
        ...
        self.repos = {
            'amanaknows': 'https://github.com/your_org/amanaknows',
            'iangelica': 'https://github.com/your_org/iangelica'
        }
...
if __name__ == "__main__":
    user = User(name="Dr. Smith", role="Institutional")
    automation = AngelNETAutomation(user)
